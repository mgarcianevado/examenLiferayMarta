...
/**
 * The base model implementation for the Usuario service. Represents a row in the &quot;LibreriaExamenLiferay_Usuario&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class UsuarioModelImpl extends BaseModelImpl<Usuario>
     ...
     */
    public static final String TABLE_NAME = "LibreriaExamenLiferay_Usuario";
    ...
    public static final String TABLE_SQL_CREATE = "create table LibreriaExamenLiferay_Usuario (groupId LONG,companyId LONG,userId LONG not null primary key,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null)";
    public static final String TABLE_SQL_DROP = "drop table LibreriaExamenLiferay_Usuario";
    public static final String ORDER_BY_JPQL = " ORDER BY usuario.userId ASC";
    public static final String ORDER_BY_SQL = " ORDER BY LibreriaExamenLiferay_Usuario.userId ASC";
