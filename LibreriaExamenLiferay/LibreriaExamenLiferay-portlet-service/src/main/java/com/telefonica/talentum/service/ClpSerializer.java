...
import com.telefonica.talentum.model.UsuarioClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "LibreriaExamenLiferay-portlet-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "LibreriaExamenLiferay-portlet";
            }
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(
                    "com.telefonica.talentum.model.impl.UsuarioImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals("com.telefonica.talentum.NoSuchUsuarioException")) {
            return new com.telefonica.talentum.NoSuchUsuarioException();
        }
